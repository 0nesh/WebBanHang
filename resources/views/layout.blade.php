                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                if($customer_id){
                                ?>
                                <li><a href="{{URL::to('/account-customer/'.$customer_id)}}"><i class="fa fa-user"></i> Tài Khoản</a></li>
                                <?php
                                }
                                else{
                                ?>
                                ...
                                elseif($customer_id && $shipping_id==null){
                                ?>
                                ...
                                <li style="margin-top: 10px; color: #696763; font-family: 'Roboto', sans-serif;font-size: 14px;font-weight: 300;padding: 0;padding-right: 0;">{{Session::get('customer_name')}}</li>
                    ...
                    <div class="col-sm-4">
                        <div class="search_box pull-right">
                            <form method="POST" action="{{URL::to('tim-kiem')}}">
                                {{ csrf_field() }}
                            <input type="text" name="search_product" placeholder="Tìm Kiếm Sản Phẩm"/>
                            <input type="submit" style="margin-top: 0;" name="search_submit" class="btn btn-success" value="Tìm Kiếm" />
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('danh-muc-san-pham/'.$values->category_id)}}">{{$values->category_name}}</a></h4>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="{{URL::to('thuong-hieu-san-pham/'.$values->brand_id)}}"> <span class="pull-right">(50)</span>{{$values->brand_name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
