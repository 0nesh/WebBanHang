...
class brandController extends Controller
{
    ...
    public function del_brand($brand_product_id) {
        $this->AuthLogin();
    ...
    public function show_brand_home($brand_id){
        ...
        return view('pages.brand.showBrand')->with('category',$cate_product)->with('brand',$brand_product)->with('brand_by_id',$brand_by_id)->with('brand_name',$brand_name);
    }
}
